<template>
  <div>
    <div class="flex flex-col lg:flex-row leading-6 text-sm mb-1 w-full">
      ...
      </div> <button type="submit" class="appearance-none bg-gray-100 rounded-lg border py-2 px-4 w-full lg:w-40 mt-4 lg:mt-0">
